...
(() => {
  ...
  async function persistAll() {
    ...
    // Always refresh title bar switcher so counts update live
  ...
  function refreshAll() {
    ...
    // If a person is selected, also update the export detail
    if (selPerson()) renderExportShiftDetail(selPerson());
  }
